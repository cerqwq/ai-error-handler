...
{{
    "error_codes": [
        {{"code": "错误码", "category": "类别", "message": "消息", "http_status": "HTTP状态码"}}
    ],
    "conventions": "命名规范"
}}"""
...
def create_tools(**kwargs) -> AIErrorHandlerTools:
    """创建错误处理工具"""
    return AIErrorHandlerTools(**kwargs)


if __name__ == "__main__":
    tools = create_tools()

    print("AI Error Handler Tools")
    print()
